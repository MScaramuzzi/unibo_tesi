...
{\Huge{\bf Design and calibration of a digital twin of a water lifting system}}\\
\vspace{3mm}
...
{\Large{\bf Supervisor: \\ Chiar.mo Prof.\\ Michele Lombardi}}

\end{minipage}
\hfill
\begin{minipage}[t]{0.40\textwidth}\raggedleft
{\Large{\bf Candidate \\ Marco Scaramuzzi}}
\end{minipage}
